...
const $=id=>document.getElementById(id);const type=document.body.dataset.forgeLane||'puzzle';let activeSub='all',activities=[];
const copy={puzzle:{title:'Solve something.',sub:'Logic, riddles and patterns.',verb:'Crack'},build:{title:'Build something.',sub:'Arrange, connect and make it work.',verb:'Build'},learn:{title:'Learn something.',sub:'Small lessons with one clear takeaway.',verb:'Learn'},challenge:{title:'Challenge yourself.',sub:'Fast rounds and clear goals.',verb:'Enter'},game:{title:'Play together.',sub:'Quick games made for rooms and turns.',verb:'Play'}};
