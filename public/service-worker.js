...
const CACHE_NAME = "trio-day-cache-v41";
...
const FILES_TO_CACHE = [
  ...
  BASE + "script.js?v=20260919-feedfix4",
  ...
  BASE + "activity-ui.js",
  BASE + "activity-catalog.js?v=20260919-catalog2",
  BASE + "forge-engine.js?v=20260919-engine3",
  BASE + "forge-interactions.js?v=20260919-interactions2",
  ...
  BASE + "task-create.js?v=20260919-create5",
