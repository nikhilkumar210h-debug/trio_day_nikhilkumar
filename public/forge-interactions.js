...
p10:{kind:'quiz',question:'A bag has 3 red, 2 blue and 1 green token. What is the probability the first two draws are different colours?',options:['1/2','2/3','11/15','4/5'],correct:2},
p11:{kind:'quiz',question:'1→3, 2→6, 3→11, 4→18. Using n²+2n, what is 5→?',options:['25','30','35','40'],correct:2},
p12:{kind:'quiz',question:'In a secret-code puzzle, what should you separate first when reading a clue?',options:['Exact-position information from correct-digit information','Easy clues from long clues','Numbers from letters','Small digits from large digits'],correct:0},
