...
function pathKey() {
  ...
  if (p === 'tasks.html' || p === 'task-create.html' || p === 'task-detail.html' || p === 'leaderboard.html' || p === 'admin-tasks.html') return 'discover';
...
export function renderNav() {
  ...
  // ── Bottom nav (mobile) — 4-item, no Create inside grid ──
